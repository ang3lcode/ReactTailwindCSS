...
export const Card = (data) => {
    ...
    const showProduct = (productDetail) => {
        context.isCheckoutSideMenuOpen ? context.toggleCheckoutSideMenu() : '' 
...
const renderIcon = (id) => {
    ...
    if (isInCart ) {
        return (
            <div 
                ...
                <CheckIcon className='h-6 w-6 text-slate-300'></CheckIcon>
            </div>
        )
    } else {
        return (
    ...
    return(
        <div             
            className="bg-white cursor-pointer w-52 h-60 rounded-lg"
